  ...
  return (
    <div>
      ...
      <div>
        <button
          className={
            selectedTrack === backgroundAudio.orchestron
              ? "ambience-switch active"
              : "ambience-switch"
          }
          id="orchestron"
          onClick={() => {
      ...
      <div>
        <button
          className={
            selectedTrack === backgroundAudio.cosmicWave
              ? "ambience-switch active"
              : "ambience-switch"
          }
          id="cosmic-waves"
      ...
      <div>
        <InstrumentButton
          label="Piano"
          name="piano"
          checked={checkedInstruments.piano}
      ...
      <div>
        <InstrumentButton
          label="Strings"
          name="strings"
          checked={checkedInstruments.strings}
          onChange={handleInstrumentChange}
          color="#009fe3"
        />
      </div>
      <div>
        <InstrumentButton
          label="Marimba"
          name="marimba"
          checked={checkedInstruments.marimba}
          onChange={handleInstrumentChange}
          color="#009fe3"
        />
      </div>
